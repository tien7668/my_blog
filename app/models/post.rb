class Post < ApplicationRecord
  ...
  def contentt
    temp = I18n.locale.to_s == "vn" ? self.content.html_safe : (I18n.locale.to_s == "en" ? self.content_en.html_safe : self.content_jp.html_safe)
    temp.blank? ? self.content.html_safe : temp
  end
  def titlee
    temp = I18n.locale.to_s == "vn" ? self.title.html_safe : (I18n.locale.to_s == "en" ? self.title_en.html_safe : self.title_jp.html_safe)
    temp.blank? ? self.title.html_safe : temp
  end
end